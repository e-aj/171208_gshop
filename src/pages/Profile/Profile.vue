...
<style scoped>
  ...
  .profile .profile-number .profile-link .profile_image .icon-touxiang {
    background: #e4e4e4;
    font-size: 62px;
  }
  ...
  .profile .profile-number .profile-link .arrow icon-jiantouyou {
    color: #fff;
    font-size: 5px;
  }
  ...
  .profile .profile_my_order .my_order >span icon-wodedingdan {
    color: #02a774;
  }
  .profile .profile_my_order .my_order >span .icon-jifen {
    color: #ff5f3e;
  }
  .profile .profile_my_order .my_order >span .icon-huiyuan-{
    color: #f90;
  }
  .profile .profile_my_order .my_order >span .icon-kefuzhongxin {
    color: #02a774;
  }
  ...
  .profile .profile_my_order .my_order .my_order_div .my_order_icon .icon-jiantouyou {
    color: #bbb;
    font-size: 10px;
  }
</style>
